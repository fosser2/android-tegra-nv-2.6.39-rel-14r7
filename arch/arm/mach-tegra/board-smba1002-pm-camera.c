...
static int smba1002_s5k6aa_power_on(void)
{
...
static int smba1002_s5k6aa_power_off(void)
{
...
static int smba1002_s5k6aa_reset(void)
{
	gpio_direction_output(S5K6AA_POWER_PIN, 0);
	mdelay(5);
	gpio_direction_output(S5K6AA_POWER_PIN, 1);
...
struct s5k6aa_platform_data smba1002_s5k6aa_data = {
	.power_on = smba1002_s5k6aa_power_on,
	.power_off = smba1002_s5k6aa_power_off,
	.reset = smba1002_s5k6aa_reset,
};

static struct i2c_board_info smba1002_i2c3_board_info_camera[] = {
	{
		I2C_BOARD_INFO("s5k6aa",  0x3e),
		.platform_data = &smba1002_s5k6aa_data,
	},
};
...
int __init smba1002_camera_init(void)
{
	int i, ret;
	struct i2c_client *client;
	struct i2c_adapter *adapter;

	pr_info("smba1002 camera init!\n");
...
//	}
	...
	for (i = 0; i < ARRAY_SIZE(smba1002_i2c3_board_info_camera); i++) {
		client = i2c_new_device(adapter,
				&smba1002_i2c3_board_info_camera[i]);
		if (client == NULL) {
...
late_initcall(smba1002_camera_init);
